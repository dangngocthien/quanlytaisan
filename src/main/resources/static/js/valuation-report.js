...
class ValuationReportManager {
  ...
  handleExportExcel() {
    ...
    let url = `${ValuationReportManager.CONFIG.API_BASE}/valuation/export-all`;
    if (departmentId) {
      url = `${ValuationReportManager.CONFIG.API_BASE}/department-valuation/${departmentId}/export`;
    }
